...
import puzzleImage from "../assets/araaus-puzzle-blue.png";
  ...
  return (
    ...
    >
      ...
      <path
        ...
        transform={`translate(${pad},${pad})`}
        fill="none"
        stroke={highlighted ? "#098efb" : "rgba(0,0,0,0.3)"}
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={isSelected ? "rgba(232,244,255,0.4)" : "rgba(0,0,0,0.25)"}
      />
      {/* Image */}
      <image
        href={PUZZLE_IMAGE}
      ...
      <path
        ...
        transform={`translate(${pad},${pad})`}
        fill="none"
        stroke={isSelected ? "#043156" : "rgba(0,0,0,0.4)"}
...
// ─── Main Component ──────────────────────────────────────────────────────────
export default function PuzzleBuilderBlue({ onClose = () => {} }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 sm:px-5 pt-4 sm:pt-5 pb-3">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              >
                <div
                  className="h-full bg-[#098efb] rounded-full transition-all duration-500"
          ...
          <div className="flex gap-2 items-center">
            <button
              ...
              className="text-xs font-sans bg-[#e7f4ff] active:bg-[#95cfff] text-[#043156] border border-[#043156] px-3 py-1.5 rounded-full flex items-center gap-1"
        ...
        {/* Tray */}
        <div
          className="bg-[#098efb] flex gap-2 items-center px-3"
          style={{
