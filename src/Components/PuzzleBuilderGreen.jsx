...
import puzzleImage from "../assets/araaus-puzzle-green.png";
  ...
  return (
    ...
    >
      ...
      <path
        ...
        transform={`translate(${pad},${pad})`}
        fill="none"
        stroke={highlighted ? "#b1f02d" : "rgba(0,0,0,0.3)"}
  ...
  return (
    ...
    >
      ...
      <path
        ...
        transform={`translate(${pad},${pad})`}
        fill="none"
        stroke={isSelected ? "#426100" : "rgba(0,0,0,0.4)"}
...
// ─── Main Component ──────────────────────────────────────────────────────────
export default function PuzzleBuilderGreen({ onClose = () => {} }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 sm:px-5 pt-4 sm:pt-5 pb-3">
          ...
          <div className="flex gap-2 items-center">
            <button
              ...
              className="text-xs font-sans bg-[#f3ffd8] active:bg-[#dcff93] text-[#6d9f03] border border-[#dcff93] px-3 py-1.5 rounded-full flex items-center gap-1"
        ...
        {/* Tray */}
        <div
          className="bg-[#B1F02D] flex gap-2 items-center px-3"
          style={{
