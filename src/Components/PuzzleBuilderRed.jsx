...
import puzzleImage from "../assets/araaus-puzzle-red.png";
  ...
  return (
    ...
    >
      ...
      <path
        ...
        transform={`translate(${pad},${pad})`}
        fill="none"
        stroke={highlighted ? "#f20101" : "rgba(0,0,0,0.3)"}
  ...
  return (
    ...
    >
      ...
      <path
        ...
        transform={`translate(${pad},${pad})`}
        fill="none"
        stroke={isSelected ? "#3d0000" : "rgba(0,0,0,0.4)"}
...
// ─── Main Component ──────────────────────────────────────────────────────────
export default function PuzzleBuilderRed({ onClose = () => {} }) {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 sm:px-5 pt-4 sm:pt-5 pb-3">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              >
                <div
                  className="h-full bg-[#f20101] rounded-full transition-all duration-500"
          ...
          <div className="flex gap-2 items-center">
            <button
              ...
              className="text-xs font-sans bg-[#ffd9d9] active:bg-[#ff9393] text-[#f20101] border border-[#f20101] px-3 py-1.5 rounded-full flex items-center gap-1"
        ...
        <div className="px-4 py-1.5 bg-slate-50 border-t border-slate-100">
          <p className="text-xs albert-sans text-gray text-center leading-tight">
            {selected !== null
        ...
        {/* Tray */}
        <div
          className="bg-[#f20101] flex gap-2 items-center px-3"
          style={{
